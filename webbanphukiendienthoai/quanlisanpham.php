...
//Nếu chưa đăng nhập thì cho về trang đăng nhập ADMIN
    ...
    $sql ="SELECT danhmuc.tenloai,sanpham.id,id_dm,anhsp,tensp,giact,giakm,thuonghieu,motasp FROM sanpham,danhmuc WHERE sanpham.id_dm=danhmuc.id ORDER BY sanpham.id DESC";
    ...
    <div id="wrapper">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="danhmucadmin.php">Quản lý danh mục</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        ...
                        <li>
                            <a href="admin_user.php"><i class="fa fa-users fa-fw"></i> Nhanvien<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                ?>
                <a href="addsanpham.php"><button  class="btn btn-success"> Thêm Sản Phẩm</button></a>
                ...
                <table class="table table-bordered">
                    ...
                    foreach($result as $values){?>
                        <tr>
                            ...
                            <td width ="30px"><a href="suasanpham.php?id=<?php echo $values["id"] ?>"><button class="btn btn-info" >Sửa</button></a></td>
                            <td width ="30px"><a href="xoasanpham.php?id=<?php echo $values["id"] ?>"><button class="btn btn-danger" >Xóa</button></a></td>
                        </tr>
                    <?php }
                    ?>
                    </tbody>
