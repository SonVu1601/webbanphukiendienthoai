...
//Nếu chưa đăng nhập thì cho về trang đăng nhập ADMIN
    ...
    $sql ="SELECT danhmuc.tenloai,sanpham.id,id_dm,anhsp,tensp,giact,giakm,khoiluong,ngaysx,hansd,thuonghieu,doituongsd,motasp FROM sanpham,danhmuc WHERE sanpham.id_dm=danhmuc.id";
