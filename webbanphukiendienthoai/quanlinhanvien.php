    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                ?>
               <a href="addnhanvien.php"><button   class="btn btn-success"> Thêm Nhân Viên</button></a>
                ...
                <table class="table table-bordered">
                    ...
                    <?php $index=1; foreach($result as $values){?>
                        <tr>
                            ...
                            <td><?php echo $values["hoten"]; ?></td>
                            <td><?php echo $values["id_ql"]; ?></td>
                            <td><?php echo $values["sodt"]; ?></td>
                            <td><?php echo $values["diachi"]; ?></td>
                            <td><?php echo $values["email"]; ?></td>
                            <td><?php echo $values["password"]; ?></td>
                            <td width ="30px"><a href="xoanhanvien.php?id=<?php echo $values["id"] ?>"><button class="btn btn-danger" >Xóa</button></a></td>
                        </tr>
                    <?php }?>
                    </tbody>
